...
from skills.ingest import DEFINITION as ingest_def, execute as ingest_exec
...
from skills.remove_from_index import DEFINITION as remove_def, execute as remove_exec

SKILL_DEFINITIONS = [reflect_def, read_doc_def, investigate_def, index_site_def, ingest_def, remove_def, report_def, time_def]
